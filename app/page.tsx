...
const SCREEN_MUSIC: Record<string, MusicName> = {
  ...
  barracks: "barracksMusic", world: "worldMusic",
};

export default function Page() {
  const [screen, setScreen] = useState<"menu" | "intro" | "nation" | "hub" | "barracks" | "trade" | "world" | "game" | "settings" | "homeland" | "doctrine" | "heroes">("menu");
  ...
  if (screen === "menu") return (
    <MainMenu hasSave={!!game.position} onContinue={() => setScreen(game.nation ? "hub" : "nation")} onNew={() => { game.reset(); setScreen("intro"); }} onSettings={() => setScreen("settings")} />
  );
